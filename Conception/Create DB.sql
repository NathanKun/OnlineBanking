...
INSERT INTO news_nws VALUES(null, "Emmanuel MACRON élu président de la République Française !", 
"Avec une estimation de 65.5% des voix, le jeune de 39 ans devient le nouveau président français pour les 5 ans à venir, devançant ainsi Marine LE PEN, la leader droite en France. Notons que le taux d'abstention est un record depuis 1969.", 
"http://france3-regions.francetvinfo.fr/hauts-de-france/sites/regions_france3/files/styles/top_big_2x/public/assets/images/2017/05/07/12424293-3041841.png?itok=jbhqj4cR", "OFFICIEL", STR_TO_DATE('2017-05-08, 06:07:08','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "BankRading expose au salon Franchise Expo Toulouse 2016",
 "BankRading expose au Salon de Toulouse. Toute l'équipe du pôle Franchise et Commerce Associé deBankRading sera présente afin d'informer sur un projet,répondre aux interrogations et conseiller/accompagner dans la réalisation d'un projet.", 
 "http://www.accesscreditspro.com/wp-content/uploads/2017/02/slider.jpg", "BankRading", STR_TO_DATE('2017-05-07, 21:22:23','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "L'euro au-dessus de $1,10 après les résultats de la présidentielle",
 "L'euro a franchi dimanche le seuil de 1,10 dollar pour la première fois depuis l'élection de Donald Trump à la présidence des Etats-Unis et a inscrit un plus haut d'un an contre le yen en réaction à la large victoire d'Emmanuel Macron.",
 "http://fm.cnbc.com/applications/cnbc.com/resources/img/editorial/2013/11/20/101216114-stacks_oh_euro_bank_notes.1910x1000.jpg", "BOURSE", STR_TO_DATE('2017-05-06, 17:18:19','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "Prêt Personnel BankRading, au printemps, c'est maintenant !", 
"Vous avez envie de partir en vacances ou de changer de voiture, vous avez besoin de remplacer une partie de votre équipement, les projets ne manquent pas, encore faut-il disposer des bons leviers pour les rendre concrets !", 
"http://img.20mn.fr/coWoab2ETqqi-wwlQm8l1w/2048x1536-fit_illustration-fleurs-printemps.jpg", "BankRading", STR_TO_DATE('2017-05-05, 11:10:09','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "BankRading et Compte-Normandie s'allient", 
"Dans le cadre des partenariats avec la Confédération des Buralistes de France, notre banque rajoute un nouvel allié à son actif.", 
"images/bank.png", "BankRading", STR_TO_DATE('2017-03-10, 14:15:16','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "Actionnaires : nouvelle plateforme !",
 "Bonne nouvelle pour le cercle des actionnaires de la BankRading, notre groupe se fortifie d'un nouveau site Internet exclusif, muni des dernières mises à jour.", 
 "images/bank.png", "BankRading", STR_TO_DATE('2017-04-15, 14:15:16','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "Groupe BankRading : Résultars au 31 mars 2017",
 "Le Conseil d'administration de la BankRading a examiné les résultats de la banque pour le premier trimestre de l'année en cours.",
 "images/bank.png", "BankRading", STR_TO_DATE('2017-05-01, 18:19:20','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "MACRON ET LE PEN AU DERNIER TOUR !", 
"Le ministère de l'Intérieur a publié les résultats définitifs du premier tour de la présidentielle ce lundi après-midi. Emmanuel Macron obtient ainsi 24,01% des suffrages exprimes, devant à 21,30%. ", 
"./images/macron.jpg", "OFFICIEL", STR_TO_DATE('2017-04-24, 14:15:16','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "le CAC40 en forte hausse après les premiers résultats.",
 "Les principales Bourses européennes ont ouvert en vive hausse lundi au lendemain du premier tour de l'élection présidentielle française qui a placé en tête Emmanuel Macron, un résultat qui profite aux actifs financiers français, en premier lieu le CAC 40 et ses valeurs bancaires.",
 "http://www.cbnews.fr/var/media/225/original/indice-cac40-224325.jpg", "BOURSE", STR_TO_DATE('2017-04-24, 07:08:09','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "LIGUE DES CHAMPIONS : Monaco dans le dernier carré !", 
...
"https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Monaco_City_001.jpg/750px-Monaco_City_001.jpg", "SPORT", STR_TO_DATE('2017-04-24, 9:15:35','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "Offre d'emploi : Ingénieur Expert en Collaboration (Voix et Vidéo)",
 "Le candidat sera affecté à un environnement à forte expertise technique allant de l'évaluation, conception, implémentation et livraison de solutions complexes. ",
 "images/bank.png", "BankRading", STR_TO_DATE('2017-05-05, 14:10:08','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "LIGUE DES CHAMPIONS : Ce sera JUVENTUS vs Real Madrid en Finale !", 
"Pour l'édition 2017 de la Coupe européenne des clubs, la JUVENTUS s'est qualifiée au détriment de l'AS MONACO, au terme d'une rencontre bouillante. Ainsi était le cas pour le REAL MADRID qui s'est contenté d'un nul au retour.", 
"https://www.cuw.edu/_files/images/test3.JPG", "SPORT", STR_TO_DATE('2017-05-07, 9:15:35','%Y-%m-%d, %H:%i:%s'));
INSERT INTO news_nws VALUES(null, "LVMH détrône Total au sommet du CAC 40",
"Andrea Tueni,analyste chez Saxo Banque:'C’est une première depuis la fin des années 1980, puisqu’il y avait habituellement des valeurs de l’industrie lourde en tête des capitalisations.'Mieux vaut vendre des robes Dior et des sacs Louis Vuitton que d’extraire et raffiner du pétrole!",
"https://r.lvmh-static.com/uploads/2015/02/lvmh-losange-noir1-2335x876.jpg", "BOURSE", STR_TO_DATE('2017-05-06, 13:12:11','%Y-%m-%d, %H:%i:%s'));
