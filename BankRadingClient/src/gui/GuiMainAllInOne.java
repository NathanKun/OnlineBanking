 ...
 *
 */
public class GuiMainAllInOne extends JFrame {
	/**
	 * generate serialVersionUID
	 */
	private static final long serialVersionUID = -617858495426708815L;
	/**
	 * full client list
	 */
	...
	private void updateJTableTSH() {
		if (!jlistAccount.isSelectionEmpty()) { // avoid event generate by reset
												// account list
			Account acc = jlistAccount.getSelectedValue();
			ArrayList<TransactionHistory> tshList;
			try {
				tshList = DbClient.findTshByAccNumber(acc.getAcc_number());
				clearJTableTSH();
