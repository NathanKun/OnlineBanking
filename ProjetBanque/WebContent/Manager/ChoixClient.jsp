    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <!--  on mettra ici les messages envoyés par les visiteurs sur le site via le formulaire nous contacter -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="login.html"><i class="fa fa-sign-out fa-fw"></i> Se déconecter </a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="ListeClients.html"><i class="fa fa-table fa-fw"></i> Liste des clients </a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Les transactions des clients </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                      ...
                      <form role="form">
                                        ...
                                        <div class="form-group">
                                            <label> Entrer le numéro de compte du client dont vous voulez visualiser les informations</label>
                                            <input class="form-control" placeholder="Numéro à 8 chiffres">
                                        </div>
                                   
                                        <button type="submit" class="btn btn-default">Accès historique</button>
