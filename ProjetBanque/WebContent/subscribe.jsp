        ...
        <div id="subscribeFormDiv">
	        <div class="row">
	            <div class="col-md-8">
	                ...
	                <form id="subscribeForm" class="form-horizontal" action="./Subscribe" onsubmit="return checkInputs()" 
	                	method="post" accept-charset="UTF-8">
	                        ...
	                        <div class="form-group">
	                          <label class="col-md-4 control-label" for="sexe">Titre</label>
	                          <div class="col-md-6">
	                        ...
	                        <div class="form-group">
	                          <label class="col-md-4 control-label" for="inputAddress">Votre Adresse</label>  
	                          <div class="col-md-6">
	                        ...
	                        <!-- Text input-->
	                        <div class="form-group">
	                          <label class="col-md-4 control-label" for="password">Choisissez votre mot de passe </label>  
	                          <div class="col-md-6">
	                        ...
	                        <!-- Text input-->
	                        <div class="form-group">
	                          <label class="col-md-4 control-label" for="password2">Confirmez mot de passe</label>  
	                          <div class="col-md-6">
	                          ...
	                          <div class="form-group">
	                                <label class="col-md-4 control-label">Je crée également un: </label> 
	            
	                            <div class="col-md-6">
	                                <input type="checkbox" id="epargne" name="epargneCheckBox" >
	                                <label for="epargne" for="epargne">Compte épargne</label>
	                                
	                                <br>
	
	                                <input type="checkbox" id="titre" name="titreCheckBox" >
	                                <label for="titre" for="titre">Compte titre</label>
	                            </div>
	                          </div>
        ...
        <div id="emailCheckDiv">
			<div class="row">
				<div class="col-md-8">
						<fieldset>
							<!-- Form Name -->
							<legend>Vérification de votre adresse mail</legend>
							<h5>Nous vous avons envoyé un mail contenant un code de vérification, </h5>
							<h5>veuillez entrer ce code pour valider votre adresse mail.</h5>
							<!-- Text input-->
							<div class="form-group">
								<label class="col-md-4 control-label" for="code">Code
									reçu : </label>
								<div class="col-md-6">
									<input id="code" name="code" class="form-control input-md"
										type="text">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<button id="emailCheckSubmit" class="btn btn-primary">Valider</button>
								</div>
							</div>
						</fieldset>
				</div>
