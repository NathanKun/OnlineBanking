...
<div id="wrapper"><!-- #wrapper -->
	...
	<section id="main"><!-- #main content and sidebar area -->
		<section id="content"><!-- #content -->
			<h1> <img src="../images/offre2.png" width="600" height="322" alt="image">  </h1>
            <h2>*Mentions legals</h2>
			
            <p> Avec votre Carte Bancaire Visa Premier BankRading, c’est vous qui décidez, vous pouvez :</p>  
			<p>-Bénéficier de garanties d’assurance et assistance pour vous et votre famille, en France et à l’étranger lors de vos voyages</p>
