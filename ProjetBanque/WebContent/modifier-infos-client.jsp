...
<head>
	...
	<title>BankRading - Modifier mes informations</title>
							...
							<div class="col-md-6">
								<input id="password" name="password" onchange="checkPw()"
									placeholder="password" class="form-control input-md"
                           			onkeydown="this.onchange();" onpaste="this.onchange();" 
									oninput="this.onchange();" type="password">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="password2" name="password2" onchange="checkPw()"
									placeholder="Confirmation depassword" class="form-control input-md"
                           			onkeydown="this.onchange();" onpaste="this.onchange();" 
									oninput="this.onchange();" type="password">
