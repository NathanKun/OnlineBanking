		...
		<form>
			<table>
				...
				<tr>
					...
					<td><input type="number" name="jour" min="1" max="31"
						style="width: 3em;" required> <input type="number"
						name="mois" min="1" max="12" style="width: 3em;" required>
						<input type="number" name="annee" min="1900" max="2000"
						style="width: 6em;" required></td>
				...
				<tr>
					...
					<td><input type="number" onkeypress="return isNumberKey(evt)"
						name="clt_postalcode" id="clt_postalcode" /></td>
				</tr>
				...
				<tr>
					...
					<td><input type="number" onkeypress="return isNumberKey(evt)"
						name="clt_telephonenumber" id="clt_telephonenumber" /></td>
				</tr>
			...
			<p>
				<input type="submit" value="Enregistrer les modifications" /> <input
					...
					OnClick="location.href='afficher-infos-client.jsp'" /> <input
